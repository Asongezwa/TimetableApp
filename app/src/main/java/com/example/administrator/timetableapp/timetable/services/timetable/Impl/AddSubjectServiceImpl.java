package com.example.administrator.timetableapp.timetable.services.timetable.Impl;
...
import com.example.administrator.timetableapp.timetable.services.timetable.AddSubjectService;
...
public class AddSubjectServiceImpl extends IntentService implements AddSubjectService {
    ...
    private static final String ACTION_ADD ="package com.example.administrator.timetableapp.timetable.services.timetable.Impl.action.ADD";
    private static final String ACTION_UPDATE ="package com.example.administrator.timetableapp.timetable.services.timetable.Impl.action.UPDATE";
    private static final String ACTION_DELETE ="package com.example.administrator.timetableapp.timetable.services.timetable.Impl.action.DELETE";


    private static final String EXTRA_ADD = "package com.example.administrator.timetableapp.timetable.services.timetable.Impl.extra.ADD";
    private static final String EXTRA_UPDATE = "package com.example.administrator.timetableapp.timetable.services.timetable.Impl.extra.UPDATE";
    private static final String EXTRA_DELETE = "com.example.administrator.timetableapp.timetable.services.timetable.Impl.extra.DELETE";
